"""
We have the ML code ready and tested.
We need to connect it with the server code.
For this, I will create the ML registry object,
that will keep information about available algorithms
and corresponding endpoints.

The registry keeps simple dict object 
with a mapping of algorithm id to algorithm object.
"""
